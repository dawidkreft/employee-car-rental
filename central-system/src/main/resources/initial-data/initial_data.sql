...
VALUES ('20ebd0bf-f4b8-4ad0-b1eb-01d373250368', null, '2020-06-03 10:17:43.106056', 'test@email.com', true,
       ...
       ('a8226bdc-595b-4be3-b2b6-164788475f41', '20ebd0bf-f4b8-4ad0-b1eb-01d373250368',
        '2020-06-03 10:17:43.106056', 'boos@email.com', true, 'Jan', '$2a$10$7zS3RPTW1e8mCFDnuc2GU.uivheGrT8nQckq.P2xYk.i.ebQeaavC', false, 'BOSS', 'Bossman'),
...
-- Cars
INSERT INTO public.car (car_id, car_plate, car_brand, car_creation_date, car_date_of_last_review,
...
VALUES ('ae98efef-0f84-46e5-bb57-26c69d6b4042','PO123' ,'BMW', current_timestamp, current_date,
        current_date, current_date, 'F10', false, 'AVAILABLE', 'PREMIUM_CAR', 2019),
       ('883116b2-f840-4c74-9c1c-ca64d1bf4185','PO121', 'BMW', current_timestamp, current_date,
        current_date, current_date, 'F30', false, 'AVAILABLE', 'PREMIUM_CAR', 2019),
       ('135ea89b-fd7e-41b1-809f-84d32f823bcd','PO122', 'Opel', current_timestamp, current_date,
        current_date, current_date, 'Astra', false, 'AVAILABLE', 'CAR', 2020),
       ('3cf4af86-cde5-4a30-82a4-cb3e48058ac4', 'PO144','Opel', current_timestamp, current_date,
        current_date, current_date, 'Astra', false, 'AVAILABLE', 'CAR', 2018),
       ('e7252fec-57f6-45d1-8dcb-9d7bd27e1682','PO145', 'Opel', current_timestamp, current_date,
        current_date, current_date, 'Insignia', false, 'AVAILABLE', 'PREMIUM_CAR', 2018),
       ('f077c68e-313c-4091-81bf-2805d81d4a13','PO146', 'Opel', current_timestamp, current_date,
